...
const dataTables: Array<{
  ...
  { id: 'medicines', label: '药品表', icon: Pill, description: '药品库存、分类、位置和有效期', statKey: 'medicines' },
  ...
  { id: 'attachments', label: '附件表', icon: Paperclip, description: '检查单、处方、药盒和说明书附件', statKey: 'attachments' },
]
