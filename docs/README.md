...
6. [P0 发布证据记录（2026-07-24）](p0-release-evidence-2026-07-24.md)：1.0.12 管理后台生产部署、线上核验和剩余阻塞项。
7. [微信云开发数据库设计](wechat-cloud-database.md)：集合、权限、云函数、管理员配置、发布前配置和外部服务接入。
8. [Web 管理后台](web-admin.md)：本地打开、后台能力、后端接口和部署建议。
...
| [P0 发布证据记录（2026-07-24）](p0-release-evidence-2026-07-24.md) | 保存本次生产部署证据、阻塞项与安全交接步骤 | 判断 1.0.12 是否可提交微信审核 |
