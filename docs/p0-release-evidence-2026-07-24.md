...
| 微信隐私保护指引 | PASS（负责人确认） | 项目负责人于 2026-07-24 确认通过；原始后台截图或审核记录未纳入仓库 |
| 双账号家庭共享与跨家庭隔离 | PASS（负责人确认） | 项目负责人于 2026-07-24 确认通过；原始账号、步骤、结果与截图未纳入仓库 |
| iOS 真机 | PASS（负责人确认） | 项目负责人于 2026-07-24 确认通过；原始机型、系统、微信版本和结果未纳入仓库 |
| Android 真机 | PASS（负责人确认） | 项目负责人于 2026-07-24 确认通过；原始机型、系统、微信版本和结果未纳入仓库 |
| 真实订阅消息触达 | PASS（负责人确认） | 项目负责人于 2026-07-24 确认通过；原始授权、送达、跳转和数据库记录未纳入仓库 |
| 微信审核与正式发布 | SUBMITTED / PENDING REVIEW | 1.0.13 已提交微信审核，等待平台结果；尚未取得审核通过或正式发布证据 |

### 1.0.13 审核状态跟进

2026-07-24，项目负责人确认 1.0.13 小程序已提交微信审核。该状态记为 `SUBMITTED / PENDING REVIEW`，只证明已经进入审核流程，不代表审核通过或正式发布。同日，项目负责人进一步确认隐私、双账号、iOS/Android 真机和真实提醒触达均已通过；原始附件未纳入仓库。
...
管理后台已经达到 `deployed + live verified（已登录和无会话两种状态）`。隐私、双账号、iOS/Android 真机和真实提醒触达均由项目负责人确认 `PASS`，但原始附件未纳入仓库。1.0.13 小程序已提交微信审核、结果待定；正式公开发布仍为 `NO-GO`，等待审核通过或正式发布证据；AppSecret 轮换为负责人延期事项。
